        ...
        window.tram = function (e) {
            ...
            function u(l, _, A) {
                if (_ !== void 0 && (A = _),
                    ...
                    return A;
                var S = A;
                return Fe.test(l) || !He.test(l) ? S = parseInt(l, 10) : He.test(l) && (S = 1e3 * parseFloat(l)),
                    0 > S && (S = 0),
                    S === S ? S : A
            }
            function f(l) {
            ...
            var g = function (l, _, A) {
                ...
                function Z(ie, ve) {
                    ...
                    ve === A && (ve = ie,
                        ie = Object),
                        U.Bare = ae;
                    var se, be = L[l] = ie[l], tt = ae[l] = U[l] = new L;
                    return tt.constructor = U,
                        U.mixin = function (Re) {
                            return ae[l] = U[l] = Z(U, Re)[l],
                                U
                        }
                        ,
                        U.open = function (Re) {
                            if (se = {},
                                ...
                                S(se))
                                for (var mr in se)
                                    _.call(se, mr) && (tt[mr] = se[mr]);
                            return T(tt.init) || (tt.init = ie),
                                U
                        }
                        ,
                        U.open(ve)
                ...
                , v = {
                    ...
                    "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function (l, _, A, S, T) {
                        return T === void 0 && (T = 1.70158),
                            (l /= S / 2) < 1 ? A / 2 * l * l * (((T *= 1.525) + 1) * l - T) + _ : A / 2 * ((l -= 2) * l * (((T *= 1.525) + 1) * l + T) + 2) + _
                    }
                    ]
                }
                , m = {
            ...
            if (B.transition) {
                var ee = B.timing.dom;
                if (k.style[ee] = v["ease-in-back"][0],
                    !k.style[ee])
                    for (var ne in m)
                        v[ne][0] = m[ne]
            }
            var D = t.frame = function () {
                ...
                , d = g(function (l) {
                    function _(te, ce) {
                        ...
                        if (!ce.weak || !this.props[de]) {
                            var je = Le[0]
                                , Me = this.props[de];
                            return Me || (Me = this.props[de] = new je.Bare),
                    ...
                    function be() {
                        ...
                        me = me.join(","),
                            this.style !== me && (this.style = me,
                                this.el.style[B.transition.dom] = me)
                    }
                    function tt(te, ce, me) {
                        var de, Le, je, Me, rn = ce !== Re, Te = {};
                        for (de in te)
                            je = te[de],
                                de in fe ? (Te.transform || (Te.transform = {}),
                                    Te.transform[de] = je) : (N.test(de) && (de = r(de)),
                                        de in V ? Te[de] = je : (Me || (Me = {}),
                                            Me[de] = je));
                        for (de in Te) {
                            if (je = Te[de],
                                Le = this.props[de],
                    ...
                    l.init = function (L, Z, ie, ve) {
                        ...
                        ie[2] && (U = ie[2]),
                            ...
                            oe.fallback || ve.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                                this.string = this.name + re + this.duration + "ms" + (this.ease != "ease" ? re + v[this.ease][0] : "") + (this.delay ? re + this.delay + "ms" : ""))
                    }
                        ,
                        l.set = function (L) {
                        ...
                        l.convert = function (L, Z) {
                            if (L == "auto" && this.auto)
                                return L;
                            var ie, ve = typeof L == "number", U = typeof L == "string";
                            switch (Z) {
                                case R:
                                    if (ve)
                                        return L;
                    ...
                    l.init = function (U) {
                        ...
                        l.render = function (U) {
                            ...
                            if (se < this.duration) {
                                ...
                                return ae = this.startRGB ? L(this.startRGB, this.endRGB, be) : T(this.begin + be * this.change),
                ...
                , _e = g(Q, function (l, _) {
                    l.init = function (A) {
                        ...
                        for (S in A.values)
                            T = A.values[S],
                                this.current[S] !== T && this.tweens.push(new Q({
                                    name: S,
                                    from: this.current[S],
                                    to: T,
                                    duration: A.duration,
                        ...
                        ,
                        l.render = function (A) {
                            var S, T, L = this.tweens.length, Z = !1;
                            for (S = L; S--;)
                                T = this.tweens[S],
                                    T.context && (T.render(A),
        ...
        Ns.exports = function () {
                ...
                , P = e.each = e.forEach = function (x, M, H) {
                    ...
                    if (y && x.forEach === y)
                        ...
                        for (var B = 0, ee = x.length; B < ee; B++)
                            if (M.call(H, x[B], B, x) === t)
                                return
                    } else
                        for (var ne = e.keys(x), B = 0, ee = ne.length; B < ee; B++)
                            if (M.call(H, x[ne[B]], ne[B], x) === t)
                                return;
                    return x
                }
                ;
            ...
            return e.template = function (x, M, H) {
                ...
                x.replace(B, function (E, b, h, j, $) {
                    return ne += x.slice(ee, $).replace(J, re),
                        ee = $ + E.length,
                        b ? ne += `'+
...
` + ne + "}",
    ...
    var Be = c((VU, Us) => {
        ...
        pe.require = function (e) {
            ...
            ;
        function Ms(e) {
            pe.env() && (nt(e.design) && Ke.on("__wf_design", e.design),
    ...
    var js = c((BU, Xs) => {
        ...
        Mi.define("edit", Xs.exports = function (e, t, r) {
            ...
            var n = {}, i = e(window), o = e(document.documentElement), a = document.location, s = "hashchange", u, f = r.load || v, y = !1;
            try {
            ...
            function N(q) {
                ...
                var P = function (W) {
                    W.data === "WF_third_party_cookies_unsupported" ? (R(F, P),
                        q(!1)) : W.data === "WF_third_party_cookies_supported" && (R(F, P),
                            q(!0))
                };
                F.onerror = function () {
                    R(F, P),
    ...
    var Ks = c((WU, zs) => {
        ...
        ub.define("focus-visible", zs.exports = function () {
            function e(r) {
                ...
                function g(R) {
                    R.metaKey || R.altKey || R.ctrlKey || (s(r.activeElement) && f(r.activeElement),
                        n = !0)
                }
                function v() {
                    n = !1
                ...
                function w(R) {
                    s(R.target) && R.target.hasAttribute("data-wf-focus-visible") && (i = !0,
    ...
    var Qs = c((HU, $s) => {
        ...
        Ys.define("focus", $s.exports = function () {
            ...
            function o() {
                typeof document < "u" && document.body.hasAttribute("data-wf-focus-within") && Ys.env.safari && (document.addEventListener("mousedown", i, !0),
            ...
            , un = {
                ...
                intro: function (e, t) {
                    t.__wf_intro || (t.__wf_intro = !0,
                        Di(t).triggerHandler(it.types.INTRO))
                },
                outro: function (e, t) {
                    t.__wf_intro && (t.__wf_intro = null,
                        Di(t).triggerHandler(it.types.OUTRO))
                }
            };
        it.triggers = {};
        it.types = {
    ...
    var Hi = c((oB, Iu) => {
        ...
        Iu.exports = function (e) {
            if (e == null)
                throw wb("Can't call method on " + e);
            return e
        }
    }
    );
    ...
    var ku = c((dB, Du) => {
        var Mu = ye(), ji = Lu(), Nu = Mu.process, Pu = Mu.Deno, qu = Nu && Nu.versions || Pu && Pu.version, Fu = qu && qu.v8, $e, vn;
        Fu && ($e = Fu.split("."),
            vn = $e[0] > 0 && $e[0] < 4 ? 1 : +($e[0] + $e[1]));
        !vn && ji && ($e = ji.match(/Edge\/(\d+)/),
            (!$e || $e[1] >= 74) && ($e = ji.match(/Chrome\/(\d+)/),
                $e && (vn = +$e[1])));
        Du.exports = vn
    }
    );
    ...
    var wr = c(Sc => {
        ...
        Sc.f = UT ? xc : function (t, r, n) {
            ...
            if ("get" in n || "set" in n)
                throw HT("Accessors not supported");
    ...
    var Bc = c((VB, Uc) => {
        var rI = Pc(), Vc = ye(), lo = Ye(), nI = Wt(), iI = yn(), fo = _t(), po = hn(), oI = co(), aI = mn(), Dc = "Object already initialized", go = Vc.TypeError, sI = Vc.WeakMap, En, Ar, _n, uI = function (e) {
        ...
        rI || po.state ? (bt = po.state || (po.state = new sI),
            kc = lo(bt.get),
            vo = lo(bt.has),
            Gc = lo(bt.set),
            En = function (e, t) {
    ...
    var bo = c((KB, sl) => {
        ...
        sl.exports = function (e, t) {
            var r = qI(e), n = 0, i = [], o;
            for (o in r)
                !_o(MI, o) && _o(r, o) && al(i, o);
            for (; t.length > n;)
                _o(r, o = t[n++]) && (~FI(i, o) || al(i, o));
            return i
        }
    }
    );
    ...
    var _l = c((tW, El) => {
        ...
        El.exports = function (e, t) {
            var r = e.target, n = e.global, i = e.stat, o, a, s, u, f, y;
            if (n ? a = To : i ? a = To[r] || a0(r, {}) : a = (To[r] || {}).prototype,
                a)
                for (s in t) {
                    if (f = t[s],
                        e.noTargetGet ? (y = n0(a, s),
                            u = y && y.value) : u = a[s],
    ...
    var ql = c((oW, Pl) => {
        var y0 = Or(), m0 = Ol(), xl = bn(), E0 = mn(), _0 = Al(), b0 = io(), T0 = co(), Sl = ">", Cl = "<", Oo = "prototype", wo = "script", Ll = T0("IE_PROTO"), Io = function () { }, Nl = function (e) {
    ...
    var Fo = c(Cr => {
        ...
        function gf(e, t, r) {
            ...
            function v(I) {
                ...
                for (var C = a = s, O = 0; O < C.length; O++)
                    C[O]();
                return I
            }
            function m(I) {
    ...
    var Kt = c(Ee => {
        ...
        function Wf(e, t, r, n, i, o, a) {
            var s = Sn(e, t);
            s == null && (s = {});
            for (var u = void 0, f = arguments.length, y = Array(f > 7 ? f - 7 : 0), g = 7; g < f; g++)
                y[g - 7] = arguments[g];
            return y.length ? u = Ve.call.apply(Ve, [null, !1, !1, s, r, n, i, o, a].concat(y)) : u = Ve(!1, !1, s, r, n, i, o, a),
                Rn(e, t, u)
        }
        function Hf(e, t) {
    ...
    var Ne, NA, PA, qA, FA, MA, DA, kA, GA, VA, UA, $f, BA, Qf, Zf = he(() => {
        ...
        Ge();
        Ne = le(Kt()),
            { IX2_SESSION_INITIALIZED: NA, IX2_SESSION_STARTED: PA, IX2_TEST_FRAME_RENDERED: qA, IX2_SESSION_STOPPED: FA, IX2_EVENT_LISTENER_ADDED: MA, IX2_EVENT_STATE_CHANGED: DA, IX2_ANIMATION_FRAME_CHANGED: kA, IX2_ACTION_LIST_PLAYBACK_CHANGED: GA, IX2_VIEWPORT_WIDTH_CHANGED: VA, IX2_MEDIA_QUERIES_DEFINED: UA } = Ie,
            $f = {
                active: !1,
                tick: 0,
                eventListeners: [],
    ...
    var id = c((t5, nd) => {
        ...
        function $A(e) {
            ...
            if (r < 0)
                return !1;
            var n = t.length - 1;
            return r == n ? t.pop() : YA.call(t, r, 1),
                --this.size,
                !0
        }
        nd.exports = $A
        ...
        function rC(e, t, r, n, i, o) {
            ...
            for (o.set(e, t),
                ...
                var w = e[g]
                    , I = t[g];
                if (n)
                    var C = a ? n(I, w, g, t, e, o) : n(w, I, g, e, t, o);
                if (C !== void 0) {
                    if (C)
                        continue;
                    v = !1;
    ...
    var Dn = c((rH, ev) => {
        ...
        function eR(e, t) {
            var r = typeof e;
            return t = t ?? ZC,
                !!t && (r == "number" || r != "symbol" && JC.test(e)) && e > -1 && e % 1 == 0 && e < t
        }
        ev.exports = eR
    }
    );
    ...
    var ia = c((sH, fv) => {
        ...
        function jR(e, t) {
            var r = VR(e)
                ...
                , u = s.length;
            for (var f in e)
                (t || XR.call(e, f)) && !(a && (f == "length" || i && (f == "offset" || f == "parent") || o && (f == "buffer" || f == "byteLength" || f == "byteOffset") || BR(f, u))) && s.push(f);
            return s
        }
        fv.exports = jR
    }
        ...
        function hL(e, t, r, n, i, o) {
            ...
            for (var C = a; ++g < u;) {
                ...
                var O = e[v]
                    , N = t[v];
                if (n)
                    var R = a ? n(N, O, v, t, e, o) : n(O, N, v, e, t, o);
        ...
        function zL(e, t, r, n) {
            ...
            for (; ++i < o;) {
                ...
                if (a && s[2]) {
                    ...
                    if (n)
                        var v = n(f, y, u, e, t, g);
                    if (!(v === void 0 ? HL(y, f, XL | jL, n, g) : v))
                        return !1
                }
            }
            return !0
    ...
    var ag = c((CH, og) => {
        ...
        function ga(e, t) {
            ...
            return r.cache = new (ga.Cache || ig),
                r
        }
        ga.Cache = ig;
        og.exports = ga
        ...
        uh.exports = function (t, r, n, i) {
            ...
            if (t !== r || n !== i)
                for (var a = 0; a < Ur; ++a)
                    o[a] = Jn(a * Zn, t, n);
            function s(u) {
                for (var f = 0, y = 1, g = Ur - 1; y !== g && o[y] <= u; ++y)
                    f += Zn;
                --y;
    ...
    var nr, oX, jq, aX, zq, Kq, Yq, $q, Qq, Zq, Jq, eF, tF, rF, nF, fh, iF, oF, aF, vh = he(() => {
        "use strict";
        nr = le(Kt());
        Ge();
                    ...
                    case rF:
                        {
                            let { elementId: r, element: n, origin: i, actionItem: o, refType: a } = t.payload
                                ...
                                , u = e;
                            return (0,
                                nr.getIn)(u, [r, n]) !== n && (u = dh(u, n, a, r, o)),
                                Aa(u, r, s, i, o)
                        }
                    case nF:
                        {
        ...
        var hh = Object.freeze({
            ...
            , _F = (e, t) => {
                ...
                if (e) {
                    let o = Object.keys(e)
                        , a = yF(n, o);
                    return a.length ? a.reduce((u, f) => (u[f] = hh[f],
                        u), e) : e
                }
                return n.reduce((o, a) => (o[a] = hh[a],
                    o), {})
            }
            ;
    ...
    var Sa = c(xa => {
        ...
        function wF(e) {
            let t, r, n, i = 1, o = e.replace(/\s/g, "").toLowerCase(), s = (typeof mh[o] == "string" ? mh[o].toLowerCase() : null) || o;
            if (s.startsWith("#")) {
                let u = s.substring(1);
                ...
                i = parseFloat(u[3]);
                let v = (1 - Math.abs(2 * g - 1)) * y, m = v * (1 - Math.abs(f / 60 % 2 - 1)), w = g - v / 2, I, C, O;
                f >= 0 && f < 60 ? (I = v,
                    C = m,
                    O = 0) : f >= 60 && f < 120 ? (I = m,
                        C = v,
                ...
                let u = s.match(/hsl\(([^)]+)\)/)[1].split(","), f = parseFloat(u[0]), y = parseFloat(u[1].replace("%", "")) / 100, g = parseFloat(u[2].replace("%", "")) / 100, v = (1 - Math.abs(2 * g - 1)) * y, m = v * (1 - Math.abs(f / 60 % 2 - 1)), w = g - v / 2, I, C, O;
                f >= 0 && f < 60 ? (I = v,
                    C = m,
                    O = 0) : f >= 60 && f < 120 ? (I = m,
                        C = v,
    ...
    var Eh = c(xe => {
        ...
        var NF = (e, t, r) => {
            let n = r.config.target.objectId, i = r.config.value.unit, { PLUGIN_VARIABLE: o } = t, { size: a, red: s, green: u, blue: f, alpha: y } = o, g;
            a != null && (g = a + i),
                s != null && f != null && u != null && y != null && (g = `rgba(${s}, ${u}, ${f}, ${y})`),
    ...
    var _h = c(ei => {
        ...
        var Ca = (Ge(),
            ...
            , FF = Ra(yh())
            , MF = Ra(Eh())
            , fX = ei.pluginMethodMap = new Map([[Ca.ActionTypeConsts.PLUGIN_LOTTIE, {
                ...qF
    ...
    var Gh = c((IX, kh) => {
        ...
        function lM(e, t, r) {
            ...
            if (!n)
                return -1;
            var i = n - 1;
            return r !== void 0 && (i = sM(r),
                i = r < 0 ? uM(n + i, 0) : cM(i, n - 1)),
                oM(e, aM(t, 3), i, !0)
        }
        kh.exports = lM
    }
    ...
    function gM(e, t) {
        ...
        for (let i = 0; i < r.length; i++)
            if (!vM.call(t, r[i]) || !Bh(e[r[i]], t[r[i]]))
                return !1;
        return !0
    }
    var vM, Va, Wh = he(() => {
    ...
    function Xa({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
        ...
        if (Array.isArray(o) && o.length > 0)
            return o.reduce((k, x) => k.concat(Xa({
                config: {
                    target: x
                },
                event: t,
        ...
        if (C)
            return [ti.has(C) ? ti.get(C) : ti.set(C, {}).get(C)];
        if (R === Ho.PAGE) {
            let k = a(I);
            return k ? [k] : []
        }
        let P = (t?.action?.config?.affectedElements ?? {})[I || O] || {}, W = !!(P.id || P.selector), X, K, J, re = t && s(jh(t.target));
        if (W ? (X = P.limitAffectedElements,
            K = re,
            J = s(P)) : K = J = s({
                id: I,
                selector: O,
            ...
            if (J) {
                if (q === CM)
                    return u(J).filter(x => k.some(M => v(x, M)));
                if (q === Hh)
                    return u(J).filter(x => k.some(M => v(M, x)));
                if (q === Xh)
                    return u(J).filter(x => k.some(M => m(M, x)))
            }
            return k
        }
    ...
    function WM(e, t = {}, r = {}, n, i) {
        ...
        switch (n.actionTypeId) {
            ...
            case ur:
                {
                    let s = o(e, ut), u = o(e, ct), f, y;
                    return n.config.widthUnit === At ? f = zh.test(s) ? parseFloat(s) : parseFloat(r.width) : f = (0,
                        gt.default)(parseFloat(s), parseFloat(r.width)),
                        n.config.heightUnit === At ? y = zh.test(u) ? parseFloat(u) : parseFloat(r.height) : y = (0,
    ...
    function tD(e, t, r, n) {
        let i = (0,
            oi.default)(t, (a, s, u) => `${a} ${u}(${s}${ZM(u, r)})`, "")
            , { setStyle: o } = n;
        Dt(e, Xr, n),
            o(e, Xr, i)
    }
    ...
    var gt, oi, ri, ai, $h, hM, yM, mM, EM, _M, bM, TM, IM, OM, wM, ni, Xr, jr, ut, ct, Qh, AM, xM, Hh, SM, Xh, CM, ii, ir, At, zr, RM, Ua, Zh, Ba, Wa, Jh, or, ar, sr, Kr, ey, Yr, $r, ur, cr, lr, fr, si, LM, ty, Ha, ry, ti, PM, FM, kM, zh, UM, BM, HM, XM, jM, ja, $M, QM, ZM, JM, iD, oD, aD, oy, uy = he(() => {
        "use strict";
        gt = le(Ih()),
            oi = le(Dh()),
            ri = le(Uh()),
        ...
        Da();
        Qn();
        ({ BACKGROUND: hM, TRANSFORM: yM, TRANSLATE_3D: mM, SCALE_3D: EM, ROTATE_X: _M, ROTATE_Y: bM, ROTATE_Z: TM, SKEW: IM, PRESERVE_3D: OM, FLEX: wM, OPACITY: ni, FILTER: Xr, FONT_VARIATION_SETTINGS: jr, WIDTH: ut, HEIGHT: ct, BACKGROUND_COLOR: Qh, BORDER_COLOR: AM, COLOR: xM, CHILDREN: Hh, IMMEDIATE_CHILDREN: SM, SIBLINGS: Xh, PARENT: CM, DISPLAY: ii, WILL_CHANGE: ir, AUTO: At, COMMA_DELIMITER: zr, COLON_DELIMITER: RM, BAR_DELIMITER: Ua, RENDER_TRANSFORM: Zh, RENDER_GENERAL: Ba, RENDER_STYLE: Wa, RENDER_PLUGIN: Jh } = Ce),
            { TRANSFORM_MOVE: or, TRANSFORM_SCALE: ar, TRANSFORM_ROTATE: sr, TRANSFORM_SKEW: Kr, STYLE_OPACITY: ey, STYLE_FILTER: Yr, STYLE_FONT_VARIATION: $r, STYLE_SIZE: ur, STYLE_BACKGROUND_COLOR: cr, STYLE_BORDER: lr, STYLE_TEXT_COLOR: fr, GENERAL_DISPLAY: si, OBJECT_VALUE: LM } = ke,
            ty = e => e.trim(),
            Ha = Object.freeze({
                [cr]: Qh,
                [lr]: AM,
        ...
        kM = (e, t) => e === t;
        zh = /px/,
            UM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = $M[n.type]),
                r), e || {}),
            BM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = QM[n.type] || n.defaultValue || 0),
                r), e || {});
    ...
    var ci, ht, xD, SD, CD, RD, LD, ND, ui, cy, PD, qD, za, FD, MD, DD, kD, ly, fy = he(() => {
        "use strict";
        Ge();
        ci = le(kt()),
            ht = le(Kt()),
            ...
            kD = (e, t) => {
                ...
                if (r && n) {
                    ...
                    if (s) {
                        ...
                        e = (0,
                            ht.set)(e, "verboseTimeElapsed", K * J)
                    }
                    if (R < 0)
                        return e;
            ...
            ly = (e = Object.freeze({}), t) => {
                switch (t.type) {
                    ...
                    case CD:
                        {
                            let { instanceId: r, elementId: n, actionItem: i, eventId: o, eventTarget: a, eventStateKey: s, actionListId: u, groupIndex: f, isCarrier: y, origin: g, destination: v, immediate: m, verbose: w, continuous: I, parameterId: C, actionGroups: O, smoothing: N, restingValue: R, pluginInstance: q, pluginDuration: F, instanceDelay: P, skipMotion: W, skipToValue: X } = t.payload
                                , { actionTypeId: K } = i
                                , J = FD(K)
                                , re = MD(J, K)
    ...
    var Ny = c((HX, Ly) => {
        ...
        function y1(e) {
            for (var t = Oy.lastIndex = 0; Oy.test(e);)
                ++t;
            return t
        }
        Ly.exports = y1
    ...
    var lm = c((aj, cm) => {
        ...
        function D2(e) {
            if (e == null)
                return !0;
            if (C2(e) && (S2(e) || typeof e == "string" || typeof e.splice == "function" || R2(e) || N2(e) || x2(e)))
                return !e.length;
            var t = A2(e);
            if (t == P2 || t == q2)
                return !e.size;
    ...
    var Im = c((dj, Tm) => {
        var Z2 = st()
            ...
            , tk = Math.min;
        function rk(e, t, r) {
            var n, i, o, a, s, u, f = 0, y = !1, g = !1, v = !0;
            if (typeof e != "function")
    ...
    var wm = c((pj, Om) => {
        ...
        function ak(e, t, r) {
            ...
            return ik(r) && (n = "leading" in r ? !!r.leading : n,
    ...
    var Am, sk, uk, ck, lk, fk, dk, pk, vk, gk, hk, yk, mk, Ek, _k, bk, Tk, Ik, Ok, wk, Ak, xk, Ja, es, ts, rs, Sk, Ck, Rk, Lk, li, Nk, ns, fi, pr, is, di, os, as, vr, ss, us, pi = he(() => {
        "use strict";
        Ge();
        Am = le(kt()),
            { IX2_RAW_DATA_IMPORTED: sk, IX2_SESSION_INITIALIZED: uk, IX2_SESSION_STARTED: ck, IX2_SESSION_STOPPED: lk, IX2_PREVIEW_REQUESTED: fk, IX2_PLAYBACK_REQUESTED: dk, IX2_STOP_REQUESTED: pk, IX2_CLEAR_REQUESTED: vk, IX2_EVENT_LISTENER_ADDED: gk, IX2_TEST_FRAME_RENDERED: hk, IX2_EVENT_STATE_CHANGED: yk, IX2_ANIMATION_FRAME_CHANGED: mk, IX2_PARAMETER_CHANGED: Ek, IX2_INSTANCE_ADDED: _k, IX2_INSTANCE_STARTED: bk, IX2_INSTANCE_REMOVED: Tk, IX2_ELEMENT_STATE_CHANGED: Ik, IX2_ACTION_LIST_PLAYBACK_CHANGED: Ok, IX2_VIEWPORT_WIDTH_CHANGED: wk, IX2_MEDIA_QUERIES_DEFINED: Ak } = Ie,
        ...
        if (e) {
            ...
            if (e.indexOf(Sm) !== -1) {
                let n = e.split(Sm)
                    , i = n[0];
                if (r = n[1],
                    i !== document.documentElement.getAttribute(Rm))
                    return null
            }
    ...
    var Cm, cs, Sm, Pk, qk, Rm, Qr, Lm = he(() => {
        "use strict";
        Cm = le(kt());
        Ge();
        ({ ELEMENT_MATCHES: cs } = Cm.IX2BrowserSupport),
            { IX2_ID_DELIMITER: Sm, HTML_ELEMENT: Pk, PLAIN_OBJECT: qk, WF_PAGE: Rm } = Ce;
    ...
    var Ym = c((Ij, Km) => {
        ...
        function iG(e, t, r) {
            return t = zm(t === void 0 ? e.length - 1 : t, 0),
                function () {
                    for (var n = arguments, i = -1, o = zm(n.length - t, 0), a = Array(o); ++i < o;)
                        a[i] = n[t + i];
                    i = -1;
    ...
    var TE = c((Mj, bE) => {
        ...
        function FG(e) {
            ...
            return t.__actions__ = qG(e.__actions__),
    ...
    var xE = c((kj, AE) => {
        ...
        function zG(e) {
            var t = XG(e)
                , r = jG[t];
            if (typeof r != "function" || !(t in WG.prototype))
                return !1;
            if (e === r)
                return !0;
            var n = HG(r);
    ...
    var jE, zE, KE, YE, uV, cV, lV, fV, dV, pV, vV, gV, hV, yV, mV, EV, _V, bV, TV, $E, QE, IV, OV, wV, ZE, AV, xV, JE, SV, ms, e_, kE, GE, t_, Jr, CV, lt, r_, RV, Ue, et, en, n_, Es, VE, _s, LV, Zr, NV, PV, qV, i_, UE, FV, BE, MV, DV, kV, WE, _i, bi, HE, XE, o_, a_ = he(() => {
        "use strict";
        jE = le(PE()),
            zE = le(jn()),
            KE = le(DE());
        ...
        YE = le(kt()),
            ...
            Ue = ({ store: e, event: t, element: r, eventStateKey: n }, i) => {
                ...
                return f && gr({
                    ...
                    actionListId: (0,
                        zE.default)(f, "action.config.actionListId")
                }),
                    gr({
                        store: e,
                        eventId: a,
            ...
            Zr = (() => {
                ...
                return () => ({
                    ...
                    stiffScrollTop: (0,
                        KE.default)(e ? window.pageYOffset : r.scrollTop, 0, r.scrollHeight - window.innerHeight),
            ...
            o_ = {
                ...
                [uV]: {
                    types: "click",
                    handler: et(lt, WE((e, { clickCount: t }) => {
                        RV(e) ? t === 1 && Ue(e) : Ue(e)
                    }
                    ))
                },
                ...
                [TV]: {
                    ...
                    handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i }, o = {
                        ...
                        return C && (O > 1 - XE || O < XE) && (O = Math.round(O)),
                            (a !== at.ELEMENT || R || R !== o.elementHovered) && (O = f ? 1 - O : O,
                                e.dispatch(pr(N, O))),
                        {
                            elementHovered: R,
                            clientX: g,
    ...
    function dU(e, t) {
        let r = n => {
            ...
            i.active && (e.dispatch(fi(n, o)),
                t ? aU(e, r) : requestAnimationFrame(r))
        }
            ;
        ...
        (0,
            hr.default)(s, (g, v) => {
                ...
                JV(C, o.mediaQueryKeys) || t.dispatch(us()),
                    w.actionTypeId === ke.GENERAL_CONTINUOUS_ACTION && (Array.isArray(m.config) ? m.config : [m.config]).forEach(R => {
                        let { continuousParameterGroupId: q } = R
                            , F = (0,
                                yt.default)(a, `${O}.continuousParameterGroups`, [])
                            , P = (0,
                                c_.default)(F, ({ id: K }) => K === q)
                            , W = (R.smoothing || 0) / 100
    ...
    function E_({ store: e, actionListId: t, eventId: r }) {
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            if (!wi(y, i.mediaQueryKey))
                return;
            f.forEach(g => {
                let { config: v, actionTypeId: m } = g
                    , w = v?.target?.useEventTarget === !0 && v?.target?.objectId == null ? {
                        target: s.target,
                        targets: s.targets
                    } : v
                    , I = Oi({
    ...
    function tn({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o = 0, immediate: a, verbose: s }) {
        ...
        if (!w || !w.length)
            return !1;
        o >= w.length && (0,
            yt.default)(g, "config.loop") && (o = 0),
            o === 0 && I && o++;
        let O = (o === 0 || o === 1 && I) && Ts(g.action?.actionTypeId) ? g.config.delay : void 0
            , N = (0,
                yt.default)(w, [o, "actionItems"], []);
        if (!N.length || !wi(v, f.mediaQueryKey))
            return !1;
    ...
    function As(e) {
        let { store: t, computedStyle: r, ...n } = e, { element: i, actionItem: o, immediate: a, pluginInstance: s, continuous: u, restingValue: f, eventId: y } = n, g = !u, v = BV(), { ixElements: m, ixSession: w, ixData: I } = t.getState(), C = UV(m, i), { refState: O } = m[C] || {}, N = ds(i), R = w.reducedMotion && jo[o.actionTypeId], q;
        if (R && u)
    ...
    function T_(e, t) {
        let { active: r, continuous: n, complete: i, elementId: o, actionItem: a, actionTypeId: s, renderType: u, current: f, groupIndex: y, eventId: g, eventTarget: v, eventStateKey: m, actionListId: w, isCarrier: I, styleProp: C, verbose: O, pluginInstance: N } = e
    ...
    var c_, yt, l_, f_, d_, p_, hr, v_, Ti, GV, Ts, Is, Ii, g_, VV, s_, Oi, UV, Os, Gt, BV, WV, h_, HV, XV, jV, zV, KV, YV, wi, $V, QV, ZV, JV, eU, Ai, ws, tU, u_, rU, nU, yU, EU, _U, bU, bs = he(() => {
        "use strict";
        c_ = le(ba()),
            yt = le(jn()),
            l_ = le(My()),
    ...
    var w_ = c(mt => {
        ...
        mt.actions = CU;
        var Cs = mt.store = (0,
            xU.createStore)(SU.default);
        function RU(e) {
            e() && (0,
                Ss.observeRequests)(Cs)
        }
        function LU(e) {
            O_(),
                (0,
    ...
    var L_ = c((Zj, R_) => {
        ...
        yr.define("links", R_.exports = function (e, t) {
            var r = {}, n = e(window), i, o = yr.env(), a = window.location, s = document.createElement("a"), u = "w--current", f = /index\.(html|php)$/, y = /\/$/, g, v;
            ...
            function m() {
                i = o && yr.env("design"),
                    ...
                    yr.scroll.off(I),
                    g = [];
                for (var O = document.links, N = 0; N < O.length; ++N)
                    w(O[N]);
        ...
        Ci.define("scroll", N_.exports = function (e) {
            ...
            function R(k, x) {
                ...
                switch (x) {
                    case "add":
                        M = k.attr("tabindex"),
                            M ? k.attr("data-wf-tabindex-swap", M) : k.attr("tabindex", "-1");
                        break;
                    case "remove":
    ...
    var F_ = c((ez, q_) => {
        "use strict";
        var NU = Be();
        NU.define("touch", q_.exports = function (e) {
            var t = {}
            ...
            e.event.special.tap = {
                ...
                ;
            function n(o) {
                var a = !1, s = !1, u = Math.min(Math.round(window.innerWidth * .04), 40), f, y;
                ...
                function v(C) {
                    if (a) {
                        ...
                        var O = C.touches
                            ...
                            , R = N - y;
                        y = N,
                            Math.abs(R) > u && r && String(r()) === "" && (i("swipe", C, {
    ...
    var k_ = c((rz, D_) => {
        ...
        Ri.define("forms", D_.exports = function (e, t) {
            var r = {}, n = e(document), i, o = window.location, a = window.XDomainRequest && !window.atob, s = ".w-form", u, f = /e(-)?mail/i, y = /^\S+@\S+$/, g = window.alert, v = Ri.env(), m, w, I, C = /list-manage[1-9]?.com/i, O = t.debounce(function () {
            ...
            function re(D, z, d, E) {
                var b = null;
                return z === "password" ? b = "Passwords cannot be submitted." : D.attr("required") ? E ? f.test(D.attr("type")) && (y.test(E) || (b = "Please enter a valid email address for: " + d)) : b = "Please fill out the required field: " + d : d === "g-recaptcha-response" && !E && (b = "Please confirm you\u2019re not a robot."),
                    b
            }
            function k(D) {
                H(D),
    ...
    var V_ = c((nz, G_) => {
        ...
        xt.define("navbar", G_.exports = function (e, t) {
            var r = {}, n = e.tram, i = e(window), o = e(document), a = t.debounce, s, u, f, y, g = xt.env(), v = '<div class="w-nav-overlay" data-wf-ignore />', m = ".w-nav", w = "w--open", I = "w--nav-dropdown-open", C = "w--nav-dropdown-toggle-open", O = "w--nav-dropdown-list-open", N = "w--nav-link-open", R = qU.triggers, q = e();
            ...
            function k(p) {
                p.overlay || (p.overlay = e(v).appendTo(p.el),
            ...
            function H(p) {
                return function (G) {
                    switch (G.keyCode) {
                        ...
                        case Se.HOME:
                        case Se.END:
                            return p.open ? (G.keyCode === Se.END ? p.selectedIdx = p.links.length - 1 : p.selectedIdx = 0,
                                ee(p),
                                G.preventDefault(),
                ...
                return function (G) {
                    if (p.open)
                        ...
                        G.keyCode) {
                            case Se.HOME:
                            case Se.END:
                                return G.keyCode === Se.END ? p.selectedIdx = p.links.length - 1 : p.selectedIdx = 0,
                                    ee(p),
                                    G.preventDefault(),
                                    G.stopPropagation();
                            case Se.ESCAPE:
            ...
            function _e(p) {
                ...
                return G.animOver ? p.menu.height(Y) : p.el.css("position") !== "fixed" && (Y -= p.el.outerHeight(!0)),
            ...
            function oe(p, G) {
                ...
                var Y = p.config;
                if ((Y.animation === "none" || !n.support.transform || Y.duration <= 0) && (G = !0),
                    R.outro(0, p.el[0]),
                ...
                function _() {
                    p.menu.height(""),
                        ...
                        p.overlay && p.overlay.children().length && (q.length ? p.menu.insertAfter(q) : p.menu.prependTo(p.parent),
    ...
    var W_ = c((iz, B_) => {
        ...
        St.define("slider", B_.exports = function (e, t) {
            var r = {}, n = e.tram, i = e(document), o, a, s = St.env(), u = ".w-slider", f = '<div class="w-slider-dot" data-wf-ignore />', y = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', g = "w-slider-force-show", v = FU.triggers, m, w = !1;
            r.ready = function () {
                a = St.env("design"),
                    I()
            }
            ...
            function R(d, E) {
                ...
                h.el.off(u),
                    ...
                    h.nav.off(u),
                    q(h),
                    a ? (h.el.on("setting" + u, x(h)),
                        k(h),
                        h.hasTimer = !1) : (h.el.on("swipe" + u, x(h)),
            ...
            function q(d) {
                ...
                if (E.duration = b != null ? parseInt(b, 10) : 500,
                    F(d.el.attr("data-infinite")) && (E.infinite = !0),
                    F(d.el.attr("data-disable-swipe")) && (E.disableSwipe = !0),
                    F(d.el.attr("data-hide-arrows")) ? E.hideArrows = !0 : d.config.hideArrows && (d.left.show(),
                        d.right.show()),
            ...
            function P(d, E, b) {
                return function (h) {
                    if (E)
                        d.hasFocus[b] = E;
                    else if (e.contains(d.el.get(0), h.relatedTarget) || (d.hasFocus[b] = E,
                        d.hasFocus.mouse && b === "keyboard" || d.hasFocus.keyboard && b === "mouse"))
                        return;
            ...
            function x(d) {
                return function (E, b) {
                    ...
                    if (E.type === "swipe")
                        return h.disableSwipe || St.env("editor") ? void 0 : b.direction === "left" ? K(d)() : b.direction === "right" ? X(d)() : void 0;
            ...
            function H(d, E) {
                ...
                j < 0 ? (j = h.length - 1,
                    b.infinite && ($.x = -d.endX,
                        $.from = 0,
                        $.to = h[0].width)) : j >= h.length && (j = 0,
                            b.infinite && ($.x = h[h.length - 1].width,
                                $.from = -h[h.length - 1].x,
                                $.to = $.from - $.x)),
                    d.index = j;
                ...
                d.nav.children().not(Q).removeClass("w-active").attr("aria-pressed", "false").attr("tabindex", "-1"),
                    b.hideArrows && (d.index === h.length - 1 ? d.right.hide() : d.right.show(),
                ...
                if (p.find(U_).removeAttr("tabindex"),
                ...
                if (d.index === d.previous)
                    return;
                if (a || d.ariaLiveLabel.text(`Slide ${j + 1} of ${h.length}.`),
                    V === "cross") {
            ...
            function ne(d) {
                var E = [], b, h = d.el.attr("data-nav-spacing");
                h && (h = parseFloat(h) + "px");
                for (var j = 0, $ = d.pages; j < $; j++)
                    b = e(f),
                        b.attr("aria-label", "Show slide " + (j + 1) + " of " + $).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"),
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "id": "661a163a5f85c8b219e84ab4|8b4d9025-bac8-a4d0-a08a-06b10816fc89",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|789c164b-984d-fc69-274b-ded113d3e098",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|7802f553-468d-e120-761c-52a48b856d63",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-7": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|1351fa40-e931-0522-b9f0-c459591b5551",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-9": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|ff574a96-3536-c690-7d66-15448ab93501",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-11": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|0e17406e-d8e8-7c52-ca4b-0cb5adf5a8ac",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|1b7b1925-189d-7b44-6e18-db85ada277ff",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|661e5dd6-d732-d5be-3420-3f6ffd7a56f2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|0b2fb9b1-5db9-e467-f69e-20f3043bbcc5",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|863c077e-f906-c3b0-fc89-ad2c777260a7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|39a0e9c6-a9ec-7083-6fca-343c39f07bff",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-23": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|b501af94-80a8-c358-f270-52053a47f8a7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-25": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|f983cdc6-c38d-64ec-7e6c-561a891c42a4",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|40936658-c74c-bebc-c1f4-400db6342fcf",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-29": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|4e30998c-b5d8-81ce-a704-f3b17f6eaa9c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-31": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|4e30998c-b5d8-81ce-a704-f3b17f6eaa9e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-33": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|4e30998c-b5d8-81ce-a704-f3b17f6eaaa2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-35": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|4e30998c-b5d8-81ce-a704-f3b17f6eaaaa",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-37": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|9873d55b-a350-4896-b128-fefcf153a6e6",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-39": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|9873d55b-a350-4896-b128-fefcf153a6e9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-41": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|02432e39-bf90-ddfc-2266-314eb8ae2be9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-43": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|02432e39-bf90-ddfc-2266-314eb8ae2bf2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-45": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|e2b38f1e-6b69-7c49-b969-27fb43f3ecdd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-47": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|ca45f5c9-faa8-5eef-b32a-e3da5e2ae43e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-49": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|d1fd19d7-42ac-3b6a-5bf2-0fc62abb18b2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-51": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|3bb5b150-a93a-49fd-13c9-e6f5e43ac28e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-53": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|5c773506-8e31-9f72-2a26-7d6fb13520b3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-55": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|bcdc57ae-9af8-8699-cf39-34ef85d4d859",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-57": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|bcdc57ae-9af8-8699-cf39-34ef85d4d85c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-59": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|b5b2d9d7-2af2-6f75-a555-fe5bdc5e6c5c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-61": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|750e4077-93c8-8324-04dd-e4f2ff0944bd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-63": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|5f8d9ce6-9bb9-8aaf-0478-5687b4093d97",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-65": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661a163a5f85c8b219e84ab4|41bdb6ce-9a30-2ca8-dafb-7a77a71294f6",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-67": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|f9e7e692-fc85-1434-eb7c-38654314e98c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-71": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|9b9b3274-9676-1b6a-e123-472b66995096",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-80": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|9b9b3274-9676-1b6a-e123-472b66995098",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-81": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|4e48a25a-3b24-d278-271b-ebb52397e6f2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-83": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|de7ca8d0-d040-0fa3-e090-ba7e613f1185",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-85": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|37a5ba35-8d09-01b2-66fa-7510c42738aa",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-87": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|37a5ba35-8d09-01b2-66fa-7510c42738ac",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-91": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c628a252e40c579e1896e|37a5ba35-8d09-01b2-66fa-7510c42738af",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-93": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c6bc6cb7450eab3cd754c|02abbc3b-5f80-0e76-6e91-b6765ebdfdf3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-97": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "662c6e69d0e9217e80641e14|1086e88b-699f-29f1-b378-b7516140c706",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
            ...
            "createdOn": 1714187987521
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Moving Text Animation",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-n",
                    ...
                    "config": {
                        ...
                        "duration": 30000,
                        "target": {
                            "selector": ".moving-content-area",
                            "selectorGuids": ["2c8d0657-cc11-2552-a0b2-d7c95cea8e6b"]
                        },
                        "xValue": -100,
                        "xUnit": "%",
                        "yUnit": "PX",
        ...
        "a-2": {
            ...
            "createdOn": 1714142622072
        },
        "a-4": {
            "id": "a-4",
            "title": "Hero Bg Animate",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n",
